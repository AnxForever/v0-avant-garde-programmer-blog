      ...
      items: [
        {
          ...
          action: () => {
            const toggle = document.querySelector("button[aria-label='Toggle Chaos Mode']") as HTMLButtonElement
          ...
          >
            ...
            <div className="max-h-[60vh] overflow-y-auto p-2">
              {filteredCommands.length === 0 ? (
                <div className="p-8 text-center font-bold text-gray-500">NO RESULTS FOUND</div>
              ) : (
            ...
            <div className="p-2 border-t-4 border-black bg-gray-50 text-xs font-mono text-center">
